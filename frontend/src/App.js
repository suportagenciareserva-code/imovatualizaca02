...
import AdminMuralOportunidades from "./pages/admin/AdminMuralOportunidades.jsx";
...
import DemandaDetalhes from "./pages/parcerias/DemandaDetalhes.jsx";
      ...
      <AuthProvider>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/admin/parcerias/demanda/:demandId" element={
              <ProtectedRoute>
                <DemandaDetalhes />
              </ProtectedRoute>
            } />
            <Route path="/admin/parcerias/demanda/:demandId/propostas" element={
              <ProtectedRoute>
                <VerPropostas />
              </ProtectedRoute>
            } />
            ...
            <Route path="/admin/master/mural" element={
              <ProtectedRoute>
